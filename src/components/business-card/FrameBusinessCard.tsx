    ...
    return (
      <div className="absolute top-4 right-4 z-10">
        <div className="relative">
          {/* 클립 */}
          <div className="absolute -left-2 w-4 h-4 bg-gradient-to-br from-gray-500 to-gray-700 rounded-full shadow-lg z-20 flex items-center justify-center transform rotate-12">
          ...
          >
            {/* 명함 앞면 */}
            <div
              className="absolute inset-0 bg-white rounded-sm transition-transform duration-500"
